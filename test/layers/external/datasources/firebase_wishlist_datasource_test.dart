...
void main() {
  group("getById", () {
    ...
    test("Deve chamar GetById e retornar os valores com sucesso", () async {
      ...
      when(() => firestore.collectionReferenceStubby.doc(wishlist.tag.id)).thenReturn(doc);
  ...
  //     expect(wishResponse.equals(WishlistModel.fromJson(wishlist.toJson()..addAll({'id': wishlistId}))), true);
  //   });
  //
